...
export const TN_DATA = (function () {
  ...
  const districts = [
    { id: "tiruvallur",       en: "Tiruvallur",        ta: "திருவள்ளூர்",          col: 5, row: 1, mlas: 10, pop: "3.73M", rto: "TN-20" },
    { id: "chennai",          en: "Chennai",           ta: "சென்னை",                col: 6, row: 1, mlas: 16, pop: "6.75M", capital: true, rto: "TN-01" },
    { id: "chengalpattu",     en: "Chengalpattu",      ta: "செங்கல்பட்டு",         col: 6, row: 2, mlas: 7,  pop: "2.55M", rto: "TN-19" },
    { id: "kanchipuram",      en: "Kanchipuram",       ta: "காஞ்சிபுரம்",          col: 5, row: 2, mlas: 4,  pop: "1.66M", rto: "TN-21" },
    { id: "vellore",          en: "Vellore",           ta: "வேலூர்",                col: 4, row: 1, mlas: 5,  pop: "1.61M", rto: "TN-23" },
    { id: "ranipet",          en: "Ranipet",           ta: "ராணிப்பேட்டை",         col: 4, row: 2, mlas: 4,  pop: "1.21M", rto: "TN-73" },
    { id: "tirupathur",       en: "Tirupathur",        ta: "திருப்பத்தூர்",         col: 3, row: 1, mlas: 4,  pop: "1.11M", rto: "TN-83" },
    { id: "krishnagiri",      en: "Krishnagiri",       ta: "கிருஷ்ணகிரி",          col: 2, row: 1, mlas: 6,  pop: "1.88M", rto: "TN-24" },
    { id: "dharmapuri",       en: "Dharmapuri",        ta: "தர்மபுரி",              col: 2, row: 2, mlas: 5,  pop: "1.51M", rto: "TN-29" },
    { id: "tiruvannamalai",   en: "Tiruvannamalai",    ta: "திருவண்ணாமலை",         col: 4, row: 3, mlas: 8,  pop: "2.46M", rto: "TN-25" },
    { id: "villupuram",       en: "Viluppuram",        ta: "விழுப்புரம்",          col: 5, row: 3, mlas: 6,  pop: "2.10M", rto: "TN-32" },
    { id: "kallakurichi",     en: "Kallakurichi",      ta: "கள்ளக்குறிச்சி",       col: 4, row: 4, mlas: 5,  pop: "1.37M", rto: "TN-15" },
    { id: "cuddalore",        en: "Cuddalore",         ta: "கடலூர்",                col: 6, row: 3, mlas: 9,  pop: "2.61M", rto: "TN-31" },
    { id: "salem",            en: "Salem",             ta: "சேலம்",                  col: 2, row: 3, mlas: 11, pop: "3.48M", rto: "TN-27" },
    { id: "namakkal",         en: "Namakkal",          ta: "நாமக்கல்",              col: 2, row: 4, mlas: 6,  pop: "1.72M", rto: "TN-28" },
    { id: "erode",            en: "Erode",             ta: "ஈரோடு",                 col: 1, row: 3, mlas: 8,  pop: "2.25M", rto: "TN-33" },
    { id: "nilgiris",         en: "The Nilgiris",      ta: "நீலகிரி",               col: 0, row: 3, mlas: 3,  pop: "0.74M", rto: "TN-43" },
    { id: "tiruppur",         en: "Tiruppur",          ta: "திருப்பூர்",            col: 1, row: 4, mlas: 8,  pop: "2.47M", rto: "TN-39" },
    { id: "coimbatore",       en: "Coimbatore",        ta: "கோயம்புத்தூர்",         col: 0, row: 4, mlas: 10, pop: "3.46M", rto: "TN-37" },
    { id: "karur",            en: "Karur",             ta: "கரூர்",                  col: 2, row: 5, mlas: 4,  pop: "1.08M", rto: "TN-47" },
    { id: "trichy",           en: "Tiruchirappalli",   ta: "திருச்சிராப்பள்ளி",    col: 3, row: 5, mlas: 9,  pop: "2.72M", rto: "TN-45" },
    { id: "perambalur",       en: "Perambalur",        ta: "பெரம்பலூர்",            col: 4, row: 5, mlas: 2,  pop: "0.57M", rto: "TN-46" },
    { id: "ariyalur",         en: "Ariyalur",          ta: "அரியலூர்",              col: 5, row: 5, mlas: 2,  pop: "0.75M", rto: "TN-61" },
    { id: "thanjavur",        en: "Thanjavur",         ta: "தஞ்சாவூர்",             col: 5, row: 6, mlas: 8,  pop: "2.41M", rto: "TN-48" },
    { id: "tiruvarur",        en: "Tiruvarur",         ta: "திருவாரூர்",            col: 6, row: 5, mlas: 4,  pop: "1.26M", rto: "TN-50" },
    { id: "nagapattinam",     en: "Nagapattinam",      ta: "நாகப்பட்டினம்",         col: 7, row: 6, mlas: 3,  pop: "0.70M", rto: "TN-51" },
    { id: "mayiladuthurai",   en: "Mayiladuthurai",    ta: "மயிலாடுதுறை",          col: 6, row: 6, mlas: 3,  pop: "0.92M", rto: "TN-82" },
    { id: "pudukkottai",      en: "Pudukkottai",       ta: "புதுக்கோட்டை",         col: 3, row: 6, mlas: 6,  pop: "1.62M", rto: "TN-55" },
    { id: "sivaganga",        en: "Sivaganga",         ta: "சிவகங்கை",              col: 3, row: 7, mlas: 4,  pop: "1.34M", rto: "TN-63" },
    { id: "ramanathapuram",   en: "Ramanathapuram",    ta: "இராமநாதபுரம்",          col: 4, row: 7, mlas: 5,  pop: "1.35M", rto: "TN-65" },
    { id: "dindigul",         en: "Dindigul",          ta: "திண்டுக்கல்",          col: 2, row: 6, mlas: 7,  pop: "2.16M", rto: "TN-57" },
    { id: "theni",            en: "Theni",             ta: "தேனி",                   col: 1, row: 6, mlas: 4,  pop: "1.24M", rto: "TN-60" },
    { id: "madurai",          en: "Madurai",           ta: "மதுரை",                  col: 2, row: 7, mlas: 10, pop: "3.04M", rto: "TN-58" },
    { id: "virudhunagar",     en: "Virudhunagar",      ta: "விருதுநகர்",            col: 2, row: 8, mlas: 6,  pop: "1.94M", rto: "TN-67" },
    { id: "thoothukudi",      en: "Thoothukudi",       ta: "தூத்துக்குடி",         col: 3, row: 8, mlas: 6,  pop: "1.75M", rto: "TN-69" },
    { id: "tenkasi",          en: "Tenkasi",           ta: "தென்காசி",              col: 1, row: 8, mlas: 5,  pop: "1.41M", rto: "TN-76" },
    { id: "tirunelveli",      en: "Tirunelveli",       ta: "திருநெல்வேலி",         col: 2, row: 9, mlas: 5,  pop: "1.67M", rto: "TN-72" },
    { id: "kanyakumari",      en: "Kanyakumari",       ta: "கன்னியாகுமரி",          col: 1, row: 9, mlas: 6,  pop: "1.87M", rto: "TN-75" },
  ];

  // Sample 2024 Lok Sabha results — DMK alliance swept TN.
  const lokSabha2024 = {
    headline: { en: "Lok Sabha 2024 — DMK Alliance: 39 of 39", ta: "மக்களவை 2024 — தி.மு.க. கூட்டணி: 39 / 39" },
    parties: [
  ...
  // Cabinet — full 35-member Council of Ministers (TVK ministry, sworn in May 2026).
  const cabinet = [
    { post: "Chief Minister",                                    name: "C. Joseph Vijay",               constituency: "Perambur",           ta: "சி. ஜோசஃப் விஜய்" },
    ...
    { post: "Natural Resources",                                 name: "Dr. T.K. Prabhu",               constituency: "Karaikudi",           ta: "" },
    { post: "Industries",                                        name: "S. Keerthana",                  constituency: "Sivakasi",            ta: "" },
    { post: "Hindu Religious & Charitable Endowments",           name: "S. Ramesh",                     constituency: "Srirangam",           ta: "" },
    { post: "Fisheries & Fishermen Welfare",                     name: "Srinath",                       constituency: "Thoothukudi",         ta: "" },
    { post: "Animal Husbandry",                                  name: "S. Kamali",                     constituency: "Avanashi",            ta: "" },
    { post: "Milk & Dairy Development",                          name: "C. Vijayalakshmi",              constituency: "Kumarapalayam",       ta: "" },
    { post: "Forests",                                           name: "R.V. Ranjithkumar",             constituency: "Kancheepuram",        ta: "" },
    { post: "Agriculture & Farmers Welfare",                     name: "R. Vinoth",                     constituency: "Kumbakonam",          ta: "" },
    { post: "Environment & Climate Change",                      name: "Rajeev",                        constituency: "Tiruvadanai",         ta: "" },
    { post: "Housing & Urban Development",                       name: "B. Rajkumar",                   constituency: "Cuddalore",           ta: "" },
    { post: "Co-operation",                                      name: "V. Gandhiraj",                  constituency: "Arakkonam",           ta: "" },
    { post: "MSME",                                              name: "P. Mathanraja",                 constituency: "Ottapidaram",         ta: "" },
    { post: "Social Welfare & Women Empowerment",                name: "K. Jegadeshwari",               constituency: "Rajapalayam",         ta: "" },
    { post: "Handlooms, Textiles & Khadi",                       name: "M. Vijay Balaji",               constituency: "Erode East",          ta: "" },
    { post: "Commercial Taxes & Registration",                   name: "D. Logesh Tamilselvan",         constituency: "Rasipuram",           ta: "" },
    { post: "Transport",                                         name: "A. Vijay Tamilan Parthiban",    constituency: "Salem South",         ta: "" },
    ...
    { post: "Minorities Welfare",                                name: "A.M. Shahjahan",                constituency: "Papanasam",           ta: "" },
    { post: "Social Justice",                                    name: "Vanni Arasu",                   constituency: "Tindivanam",          ta: "" },
  ];
